 ...
 */
	...
	{
		die('<html><head><title>Current Cache Stats</title></head><body><h1>Sorry.</h1><p>You do not have permission to view current cache stats.</p><p>Only Reason users who have sensitive data viewing privileges may do that.</p></body></html>');
	}
...
limit '.$start.', '.$per_page;
	...
	$q_total = 'select "TOTAL" AS cache_key, '.$q_calcs.' from page_cache_log '.$where;
