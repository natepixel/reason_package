 ...
 */
domain_define( 'REASON_PACKAGE_HTTP_BASE_PATH','/reason_package/www/');
...
define('LOKI_2_HTTP_PATH','/reason_package/www/loki_2.0/');

// Define the path to tinymce files
define('TINYMCE_HTTP_PATH','/reason_package/www/tiny_mce/');
...
define('JQUERY_HTTP_PATH','www/jquery/');
