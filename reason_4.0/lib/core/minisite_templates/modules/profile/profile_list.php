...
class ProfileDisplayModule extends DefaultMinisiteModule
{
	...
	function run()
	{
		...
		foreach ($this->profiles as $person)
		{
			...
			if (!empty($this->params['limit_to_profile_types']) && 
				!count(array_intersect($this->params['limit_to_profile_types'], $affiliations))) continue;
